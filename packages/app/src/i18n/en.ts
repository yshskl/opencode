export const dict = {
  ...
  "command.category.custom": "Custom",
  ...
  "command.sessions.migrate.button": "Migrate",
  "command.sessions.migrate.title": "Select project directory",
  "command.sessions.migrate.success": "Session migrated successfully",
  "command.sessions.migrate.error": "Failed to migrate session",
